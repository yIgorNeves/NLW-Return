...
export function FeedbackSuceessStep({
        ...
        <>
            ...
            <div className="flex flex-col items-center py-18 w-[304px] ">
                ...
                <button
                    ...
                    className="py-2 px-6 mt-6 bg-zinc-800 border-transparent rounded-md leading-6 hover:bg-zinc0700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors"
                >
                    Quero enviar outro
                </button>
